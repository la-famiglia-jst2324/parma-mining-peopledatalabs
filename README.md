# parma-mining-peopledatalabs

[![Chore](https://github.com/la-famiglia-jst2324/parma-mining-peopledatalabs/actions/workflows/chore.yml/badge.svg?branch=main)](https://github.com/la-famiglia-jst2324/parma-mining-peopledatalabs/actions/workflows/chore.yml)
[![CI](https://github.com/la-famiglia-jst2324/parma-mining-peopledatalabs/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/la-famiglia-jst2324/parma-mining-peopledatalabs/actions/workflows/ci.yml)
[![Deploy](https://github.com/la-famiglia-jst2324/parma-mining-peopledatalabs/actions/workflows/release.yml/badge.svg)](https://github.com/la-famiglia-jst2324/parma-mining-peopledatalabs/actions/workflows/release.yml)
[![Major Tag](https://github.com/la-famiglia-jst2324/parma-mining-peopledatalabs/actions/workflows/tag-major.yml/badge.svg)](https://github.com/la-famiglia-jst2324/parma-mining-peopledatalabs/actions/workflows/tag-major.yml)

ParmaAI mining module for People Data Labs. This module collects data from People Data Labs by using their API and provides these data to Parma Analytics.
...
2. **Clone the repository**
   ...
   ```bash
   git@github.com:la-famiglia-jst2324/parma-mining-peopledatalabs.git
   ```
...
```bash
.
├── parma_mining.peopledatalabs: Main sourcing code
...
This module requires an People Data Labs account and respecting API Key.
To get the API Key please refer to [here](https://docs.peopledatalabs.com/docs/quickstart#creating-an-account).
